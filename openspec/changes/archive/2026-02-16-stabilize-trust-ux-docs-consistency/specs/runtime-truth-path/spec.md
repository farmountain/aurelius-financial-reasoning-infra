...
#### Scenario: Product and CRV gate routes are executable in acceptance path
- **WHEN** end-to-end acceptance runs invoke dev, CRV, and product gate routes with valid artifacts
- **THEN** gate endpoints execute and return contract-valid responses instead of not-found failures

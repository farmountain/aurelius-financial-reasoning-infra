...
- [ ] 7.1 Refactor `api/services/promotion_readiness.py` to conform to primitive API standards
- [ ] 7.2 Create `/api/primitives/v1/readiness/score` endpoint exposing scorecard externally
